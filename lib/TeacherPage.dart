  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     endDrawer: Drawer(
        ...
        ListTile(
          title: Text("                                           تلاميذي",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Cairo'),),
          onTap: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context){return ListeEleve(username:widget.username);} ));
                },
        ...
        ListTile(
          ...
          onTap: (){
             Navigator.of(context).push(MaterialPageRoute(builder: (context){return ListeTestTeacher(username:widget.username);} ));
          },
                 ...
                 Container(
                   ...
                   child: Row(mainAxisAlignment: MainAxisAlignment.end,
                     children: [
                       ...
                       Text("...سلام",style: TextStyle(fontFamily: 'Cairo'),),
