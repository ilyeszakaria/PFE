...
class ReponceTest extends StatefulWidget {
  ...
  const ReponceTest({Key? key, required this.idtest, required this.AyaDebut, required this. AyaFin, required this.datetest, required this.SouraDebut, required this.SouraFin, required this.username}) : super(key: key);
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
                 ...
                 Text("   ${widget.datetest}",style: TextStyle(fontFamily: 'Cairo'),),
                 VerticalDivider(color: Colors.white,),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Icon(Icons.watch_later,color: Colors.brown,),
                  
                   VerticalDivider(color: Colors.white,),
                   Text("15:30",style: TextStyle(fontFamily: 'Cairo'),),
                       ...
                       Container(
                         ...
                         children: [
                           Container(
                             ...
                             width: 230,
                             child:Text(reponce.username,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,fontFamily: 'Cairo'),),
                           ),
                           Divider(height: 8,),
                           Container(
                             alignment: Alignment.centerRight,
