import 'dart:convert';
import 'package:application3/ListeEleveInvitation.dart';
...
class _ListeEleveState extends State<ListeEleve> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:   AppBar(
        title: Text("               قائمة التلاميذ  ",style: TextStyle(fontFamily: 'Cairo'),),
         actions: [
          ...
          builder: (context,snapchot){
            ...
            itemBuilder :(context, index) {
             ...
             return GestureDetector(
               onTap: () {
                 Navigator.of(context).push(MaterialPageRoute(builder: (context){return ProfilElve(idstudent:student.id,username: widget.username,);} ));
               },
                child: Container(
               child: Row(children: [
                   Container(
