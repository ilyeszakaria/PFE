...
class ProfilElve extends StatefulWidget {
  ...
  ProfilElve({Key? key, required this.idstudent,required this.username}) : super(key: key);

  @override
  State<ProfilElve> createState() => _ProfilElveState();
}

class _ProfilElveState extends State<ProfilElve> {
      ...
      body: AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          children: [
               ...
               Container(
                    ...
                    child:Column(
                      ...
                      children: [
                        Container(
                          ...
                          height: 25,
                          width: 80,
                          child: Text("Abdeljalil",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Cairo',)),
                        ),
                        ...
                        Container(
                          ...
                          height: 25,
                          width: 80,
                          child:Text("Harzoat",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Cairo')),
                        ),
                ...
                Container(
                  ...
                  child: Column(children: [
                     Container(
                       child: CircleAvatar(child: Icon(Icons.person,size: 50,color: Colors.black,),backgroundColor: Colors.grey,),
                       height:85,
                       width: 110,
        ...
        Container(
          ...
          child:FutureBuilder(
            ...
            builder: (context,AsyncSnapshot<List<Tilawa>> snapchot){
               ...
               child: Row(children: [
                   ...
                   child: Column(
                     children: [
                       ...
                       Text(tilawa.date,style: TextStyle(fontFamily: 'Cairo'),),
                         ...
                         children: [
                           Container(
                             ...
                             child:   Row(
                               mainAxisAlignment: MainAxisAlignment.end,
                               children: [
                                 Text(tilawa.AyaDebut,style: TextStyle(fontFamily: 'Cairo'),),
                                 Text("   : اللاية رقم   ",style: TextStyle(fontSize:15,fontWeight: FontWeight.w500,fontFamily: 'Cairo')),
                                 Text(tilawa.SouraDebut,style: TextStyle(fontFamily: 'Cairo'),),
                           ...
                           Container(
                             ...
                             child: Row(
                               mainAxisAlignment: MainAxisAlignment.end,
                               children: [
                                 Text(tilawa.AyaFin,style: TextStyle(fontFamily: 'Cairo'),),
                                 Text("   : اللاية رقم      ",style: TextStyle(fontSize:12,fontWeight: FontWeight.w500,fontFamily: 'Cairo')),
                                 Text(tilawa.SouraFin,style: TextStyle(fontFamily: 'Cairo'),),
                                 Text("   : الى سورة",style: TextStyle(fontSize:13,fontWeight: FontWeight.w500,fontFamily: 'Cairo'))
        ...
        Container(
          ...
          child: FutureBuilder<List<TestStudent>>(
            ...
            itemBuilder :(context, index) {
             ...
             return GestureDetector(
               onTap: (){
                 Navigator.of(context).push(MaterialPageRoute(builder: (context){return MessageTest(username: widget.username,idstudent: test.student,idtest: test.test,);} ));
               },
               child: Container(
               ...
               child: Row(children: [
                   ...
                   height: 80,
                   width: 100,
                   child: Text(test.date,style: TextStyle(fontFamily: 'Cairo'),),
                   alignment: Alignment.center,
                 ),
                 Container(
                   margin: EdgeInsets.symmetric(horizontal: 5),
                           ...
                           Container(
                             ...
                             child: Row(
                               ...
                               children: [
                                 ...
                                 Text("   : اللاية رقم      ",style: TextStyle(fontSize:15,fontWeight: FontWeight.w500,fontFamily: 'Cairo')),
                                 Text(test.SouraFin,style: TextStyle(fontFamily: 'Cairo'),),
