              ...
              GestureDetector(
                 ...
                 onTap: () {
                   if(isPlaying){
                        ...
                        playMusic('https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3');
                      }
                     ...
                     child: Icon(isPlaying==true ? Icons.stop : Icons.play_arrow),
              ),
              Text(messageTilawa.audio ,style: TextStyle(fontSize: 15),),
            ],
          )
        ),
      ),
