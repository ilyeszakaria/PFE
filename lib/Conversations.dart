...
class _ConversaationState extends State<Conversaation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:   AppBar(
        title: Text("                      المحادثات  ",style: TextStyle(fontFamily: 'Cairo'),),
            ...
            itemBuilder :(context, index) {
             ...
             return GestureDetector(
               ...
               child: Row(children: [
                   ...
                   child: Text(conversation.username,style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,fontFamily: 'Cairo'),),
                 ),
                 Container(
                   width: 80,
                   height: 55,
